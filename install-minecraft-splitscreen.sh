...
readonly REPO_BASE_URL="https://raw.githubusercontent.com/Aroax/MinecraftSplitscreenSteamdeck/main/modules"
...
download_modules() {
    ...
    if [[ $failed_count -gt 0 ]]; then
        ...
        echo ""
        echo "🌐 Or check if the repository exists at: https://github.com/Aroax/MinecraftSplitscreenSteamdeck"
        exit 1
    fi
